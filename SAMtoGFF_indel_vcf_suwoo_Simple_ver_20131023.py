...
BAM_SAM_TMP_file_directory = sys.argv[1] #(should be a folder)
Output_TMP_file_name = sys.argv[2]
path_to_sam_tools = sys.argv[3]
path_to_dna_fasta_files = sys.argv[4]
path_to_output_sixframe_files = sys.argv[5]
...
for chromosome in temp:	
	...
	cmd_line_str = "python ACGT03102013.py " + Output_ms2db_file_name_per_chr + " " + Output_fasta_file_name_per_chr + " 30"
...
#	print "  -Searching MS/MS with MSGFPlus"
#
#	cmd_line_str = "python ACGT03102013.py " + Output_ms2db_file_name_per_chr + " " + Output_fasta_file_name_per_chr + " 30"
#
#"java -Xmx"1"G -jar MSGFPlus.jar "
#"-s "
#/data/repository/CPTAC/MSSpectra/CompRef/CompRef_Proteome_JHUC_iTRAQ/CompRef_Proteome_JHUC_iTRAQ_mzML/120511_CotterR_TS_fraction15.mzML -o /data/repository/CPTAC/MSSpectra/CompRef/CompRef_Proteome_JHUC_iTRAQ/RefSeqResult/RefSeq_GRCh37_70_120511_CotterR_TS_fraction15_Homo_sapiens.GRCh37.70.pep.all.mzid -d /data/repository/CPTAC/Database/RefSeq/Homo_sapiens.GRCh37.70.pep.all.fa -t 20ppm -tda 1 -m 3 -inst 1 -e 1 -ntt 1 -thread 1 -mod /data/repository/CPTAC/MSSpectra/CompRef/CompRef_Proteome_JHUC_iTRAQ/Exp/Mods.txt
#
#	#print "    ",cmd_line_str
#	os.system(cmd_line_str)
